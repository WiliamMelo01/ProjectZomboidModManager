...
### Added
- **Fill Workshop IDs Button**: Added a 1-click "Preencher Workshop IDs" action in the Server Details view for local servers, allowing users to populate Workshop IDs into the `.ini` configuration whenever desired.
