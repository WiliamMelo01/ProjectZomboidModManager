    ...
    translation: {
      ...
      settings: {
        ...
        steamcmd: {
          ...
          configured: "SteamCMD source configured",
          notConfigured: "No extra SteamCMD source configured",
          hint: "Optional: enter an existing steamcmd.exe to list mods already downloaded there.",
          executablePath: "Executable path",
          browse: "Browse",
          detect: "Detect",
          detected: "SteamCMD found. Save to list mods from this existing install.",
          selected: "SteamCMD selected. Save to list mods from this existing install.",
          notFound: "SteamCMD was not found automatically.",
          emptyHint: "When empty, downloads still use the managed isolated pool. Detection checks STEAMCMD_PATH, PATH and common locations such as C:\\steamcmd.",
    ...
    translation: {
      ...
      settings: {
        ...
        steamcmd: {
          ...
          configured: "Fonte SteamCMD configurada",
          notConfigured: "Nenhuma fonte SteamCMD extra configurada",
          hint: "Opcional: informe um steamcmd.exe existente para listar mods já baixados nele.",
          executablePath: "Caminho do executável",
          browse: "Procurar",
          detect: "Detectar",
          detected: "SteamCMD encontrado. Salve para listar mods dessa instalação existente.",
          selected: "SteamCMD selecionado. Salve para listar mods dessa instalação existente.",
          notFound: "SteamCMD não foi encontrado automaticamente.",
          emptyHint: "Mesmo vazio, os downloads usam o pool isolado gerenciado. A detecção procura pelo STEAMCMD_PATH, PATH e locais comuns como C:\\steamcmd.",
