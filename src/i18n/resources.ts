  ...
  en: {
    translation: {
      ...
      dependency: {
        ...
        steamcmdHint: "Configure the Linux SteamCMD path before downloading this Workshop dependency.",
      ...
      remoteSetup: {
        ...
        step2Title: "SteamCMD",
        step2Description: "Install SteamCMD on the Linux remote host under /var/lib/pzmm.",
        step2Header: "Install SteamCMD",
        step2Subheader: "This prepares the Linux SteamCMD folder used by the remote workspace.",
        ...
        step3ModeDownloadDesc: "Run app_update 380870 for the selected branch on the Linux host.",
        step3BranchLabel: "Server branch",
        step3BranchDefaultTitle: "Default",
        step3BranchDefaultDesc: "SteamCMD public branch. Recommended for normal servers.",
        step3BranchUnstableTitle: "Latest unstable",
        step3BranchUnstableDesc: "Adds -beta unstable. Use for testing newer builds.",
        linuxPathRequired: "Remote Linux workspaces require absolute Linux paths like /var/lib/pzmm/zomboid-server.",
      ...
      workspaceSelector: {
        ...
        sshHelpIntro: "Configure the Linux server, then use the Public Key button in this app to copy the generated key into authorized_keys.",
        sshHelpStep1Title: "1. Install OpenSSH (Client & Server)",
        sshHelpStep1Body: "Run the server-side command on Ubuntu/Debian with sudo:",
        sshHelpStep1LocalCode: "# On your Local PC (Client):\nAdd-WindowsCapability -Online -Name OpenSSH.Client~~~~0.0.1.0",
        sshHelpStep1RemoteCode: "sudo apt-get update\nsudo apt-get install -y openssh-server\nsudo systemctl enable --now ssh",
        sshHelpStep2Title: "2. Start and Enable SSH Services",
        sshHelpStep2Body: "Use systemd on the Linux server to enable sshd and keep it running:",
        ...
        sshHelpStep3Body: "Ensure your cloud security group or Linux firewall allows inbound TCP 22.",
        sshHelpStep3Code: "# Cloud: allow inbound TCP 22 in the instance security group\nsudo ufw allow OpenSSH || true",
        sshHelpStep4Title: "4. Generate & Setup SSH Keys (Recommended)",
        sshHelpStep4Body: "Generate or select an SSH key pair on your local PC:",
  ...
  "pt-BR": {
    translation: {
      ...
      dependency: {
        ...
        steamcmdHint: "Configure o caminho do SteamCMD Linux antes de baixar esta dependência da Workshop.",
      ...
      downloads: {
        ...
        configureHint: "Configure o caminho do SteamCMD Linux para liberar downloads.",
        configure: "Configurar",
      ...
      remoteSetup: {
        ...
        step2Title: "SteamCMD",
        step2Description: "Instala o SteamCMD no host Linux remoto em /var/lib/pzmm.",
        step2Header: "Instalar SteamCMD",
        step2Subheader: "Isso prepara a pasta Linux do SteamCMD usada pelo workspace remoto.",
        ...
        step3ModeDownloadDesc: "Executa app_update 380870 para a branch escolhida no host Linux.",
        step3BranchLabel: "Branch do servidor",
        step3BranchDefaultTitle: "Padrão",
        step3BranchDefaultDesc: "Branch pública do SteamCMD. Recomendada para servidores normais.",
        step3BranchUnstableTitle: "Latest unstable",
        step3BranchUnstableDesc: "Adiciona -beta unstable. Use para testar builds mais novas.",
        linuxPathRequired: "Workspaces remotos Linux exigem caminhos absolutos Linux, como /var/lib/pzmm/zomboid-server.",
      ...
      workspaceSelector: {
        ...
        sshHelpIntro: "Configure o servidor Linux remoto e depois use o botão Public Key no app para copiar a chave gerada para o authorized_keys.",
        sshHelpStep1Title: "1. Instalar o OpenSSH (Cliente e Servidor)",
        sshHelpStep1Body: "Execute o comando no servidor Ubuntu/Debian com sudo:",
        sshHelpStep1LocalCode: "# No seu PC Local (Cliente):\nAdd-WindowsCapability -Online -Name OpenSSH.Client~~~~0.0.1.0",
        sshHelpStep1RemoteCode: "sudo apt-get update\nsudo apt-get install -y openssh-server\nsudo systemctl enable --now ssh",
        sshHelpStep2Title: "2. Iniciar e Habilitar os Serviços SSH",
        sshHelpStep2Body: "Use systemd no servidor Linux para habilitar e manter o sshd rodando:",
        ...
        sshHelpStep3Body: "Garanta que o security group da nuvem ou firewall Linux permita TCP 22 de entrada.",
        sshHelpStep3Code: "# Nuvem: libere TCP 22 de entrada no security group da instância\nsudo ufw allow OpenSSH || true",
        sshHelpStep4Title: "4. Gerar e Configurar Chaves SSH (Recomendado)",
        sshHelpStep4Body: "Gere ou selecione um par de chaves SSH no seu PC local:",
        sshHelpStep4GenCode: "ssh-keygen -t ed25519 -f \"$HOME\\.ssh\\id_ed25519\"",
