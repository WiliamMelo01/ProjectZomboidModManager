  ...
  "pt-BR": {
    translation: {
      ...
      dashboard: {
        ...
        emptyBuild: "Nenhum servidor encontrado para esta vers?o.",
        ...
        deleteBody: "{{name}} ser? removido da lista de servidores. Os arquivos do perfil ser?o movidos para um backup de seguran?a.",
        ...
        deleteErrorTitle: "N?o foi poss?vel apagar o servidor",
        deleteErrorBody: "N?o foi poss?vel apagar {{name}}: {{error}}",
