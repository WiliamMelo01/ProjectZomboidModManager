export const resources = {
  en: {
    translation: {
      ...
      remoteSetup: {
        modalTitle: "Remote server setup",
        step1Title: "Configure helper component",
        step1Description: "Send and configure the remote helper component so the server can run management logic.",
        step1Header: "Configure remote helper",
        step1Subheader: "This uploads and configures the helper component on the remote host so scans and commands can be executed.",
        
        step2Title: "SteamCMD",
        step2Description: "Install steamcmd.exe in the same managed pool layout used by the local workspace.",
        step2Header: "Install SteamCMD",
        step2Subheader: "This mirrors the local managed SteamCMD pool on the remote Windows user profile.",
        step2DirLabel: "Remote SteamCMD pool instance",
        step2PathLabel: "steamcmd.exe",
        step2PanelTitle: "SteamCMD upload and extract",
        step2InstallBtn: "Install SteamCMD",
        step2Installing: "Installing...",
        
        step3Title: "Zomboid server",
        step3Description: "Use an existing dedicated server folder or download it through SteamCMD.",
        step3Header: "Configure Project Zomboid server",
        step3Subheader: "Point to an existing dedicated server installation, or let SteamCMD download app 380870.",
        step3ModeExistingTitle: "Already installed",
        step3ModeExistingDesc: "Save the remote folder and launch file path.",
        step3ModeDownloadTitle: "Download with SteamCMD",
        step3ModeDownloadDesc: "Run app_update 380870 validate on the VM.",
        step3DirLabel: "Remote Zomboid server folder",
        ...
        step4Title: "Ready",
        step4Description: "Remote paths are saved in remote-workspace.ini.",
        step4Header: "Remote workspace paths saved",
        step4Subheader: "These paths are now stored in remote-workspace.ini and will be reused by the remote workspace.",
        
        btnBack: "Back",
        btnSend: "Send setup",
        btnSending: "Sending...",
        btnDone: "Done",
        sshKeyNotice: "Remote setup currently requires SSH private key authentication.",
      },
      workspaceSelector: {
        helpSshBtn: "Help configuring OpenSSH",
        sshHelpModalTitle: "How to configure OpenSSH on Windows",
        sshHelpIntro: "To connect to a remote Windows Server via SSH, you need to have the OpenSSH Client installed on your local PC and the OpenSSH Server active on the remote host.",
        sshHelpStep1Title: "1. Install OpenSSH (Client & Server)",
        sshHelpStep1Body: "Open PowerShell as Administrator and run the corresponding command:",
        sshHelpStep1LocalCode: "# On your Local PC (Client):\nAdd-WindowsCapability -Online -Name OpenSSH.Client~~~~0.0.1.0",
        sshHelpStep1RemoteCode: "# On the Remote Host (Server):\nAdd-WindowsCapability -Online -Name OpenSSH.Server~~~~0.0.1.0",
        sshHelpStep2Title: "2. Start and Enable SSH Services",
        sshHelpStep2Body: "Run these commands in PowerShell as Administrator to start the services and configure them to run automatically on boot:",
        sshHelpStep2LocalCode: "# On your Local PC (SSH Agent for key auth):\nSet-Service -Name ssh-agent -StartupType Automatic\nStart-Service ssh-agent",
        sshHelpStep2RemoteCode: "# On the Remote Host (sshd Server):\nSet-Service -Name sshd -StartupType Automatic\nStart-Service sshd",
        sshHelpStep3Title: "3. Open Firewall Port 22 (Remote Host)",
        sshHelpStep3Body: "Ensure port 22 is open for inbound connections on the remote Windows firewall by running:",
        sshHelpStep3Code: "New-NetFirewallRule -Name \"OpenSSH-In\" -DisplayName \"OpenSSH Server (sshd)\" -Enabled True -Direction Inbound -Protocol TCP -Action Allow -LocalPort 22",
        sshHelpStep4Title: "4. Generate & Setup SSH Keys (Recommended)",
        sshHelpStep4Body: "On your Local PC, open PowerShell and generate your key pair:",
        sshHelpStep4GenCode: "ssh-keygen -t ed25519 -f \"$HOME\\.ssh\\id_ed25519\"",
        sshHelpStep4SetupBody: "Then, append the contents of your local public key ($HOME\\.ssh\\id_ed25519.pub) to the remote server's authorized keys file:",
        sshHelpStep4SetupCode: "# On Remote VM (Administrator account):\nC:\\Users\\Administrator\\.ssh\\authorized_keys",
  ...
  "pt-BR": {
    translation: {
      ...
      remoteSetup: {
        modalTitle: "Configuração do servidor remoto",
        step1Title: "Configurar componente helper",
        step1Description: "Envia e configura o componente helper remoto para que o servidor possa executar a lógica de gerenciamento.",
        step1Header: "Configurar helper remoto",
        step1Subheader: "Isso envia e configura o componente helper no host remoto para que varreduras e comandos possam ser executados.",
        
        step2Title: "SteamCMD",
        step2Description: "Instala o steamcmd.exe no mesmo layout de pool gerenciado utilizado pelo workspace local.",
        step2Header: "Instalar SteamCMD",
        step2Subheader: "Isso espelha o pool do SteamCMD local gerenciado no perfil de usuário Windows remoto.",
        step2DirLabel: "Instância de pool do SteamCMD remoto",
        step2PathLabel: "steamcmd.exe",
        step2PanelTitle: "Upload e extração do SteamCMD",
        step2InstallBtn: "Instalar SteamCMD",
        step2Installing: "Instalando...",
        
        step3Title: "Servidor Zomboid",
        step3Description: "Usa uma pasta de servidor dedicado existente ou realiza o download pelo SteamCMD.",
        step3Header: "Configurar servidor Project Zomboid",
        step3Subheader: "Aponte para uma instalação de servidor dedicado existente ou deixe o SteamCMD baixar o app 380870.",
        step3ModeExistingTitle: "Já instalado",
        step3ModeExistingDesc: "Salva a pasta remota e o caminho do arquivo de inicialização.",
        step3ModeDownloadTitle: "Baixar com SteamCMD",
        step3ModeDownloadDesc: "Executa app_update 380870 validate na VM.",
        step3DirLabel: "Pasta do servidor Zomboid remoto",
        ...
        step4Title: "Pronto",
        step4Description: "Caminhos remotos salvos em remote-workspace.ini.",
        step4Header: "Caminhos do workspace remoto salvos",
        step4Subheader: "Estes caminhos agora estão armazenados no arquivo remote-workspace.ini e serão reutilizados pelo workspace remoto.",
        
        btnBack: "Voltar",
        btnSend: "Enviar setup",
        btnSending: "Enviando...",
        btnDone: "Concluído",
        sshKeyNotice: "A configuração remota atualmente requer autenticação por chave privada SSH.",
      },
      workspaceSelector: {
        helpSshBtn: "Como configurar OpenSSH",
        sshHelpModalTitle: "Como configurar o OpenSSH no Windows",
        sshHelpIntro: "Para se conectar a um Windows Server remoto via SSH, você precisa ter o cliente OpenSSH instalado no seu PC local e o servidor OpenSSH ativo no host remoto.",
        sshHelpStep1Title: "1. Instalar o OpenSSH (Cliente e Servidor)",
        sshHelpStep1Body: "Abra o PowerShell como Administrador e execute o comando correspondente:",
        sshHelpStep1LocalCode: "# No seu PC Local (Cliente):\nAdd-WindowsCapability -Online -Name OpenSSH.Client~~~~0.0.1.0",
        sshHelpStep1RemoteCode: "# No Host Remoto (Servidor):\nAdd-WindowsCapability -Online -Name OpenSSH.Server~~~~0.0.1.0",
        sshHelpStep2Title: "2. Iniciar e Habilitar os Serviços SSH",
        sshHelpStep2Body: "Execute estes comandos no PowerShell como Administrador para iniciar os serviços e configurá-los para iniciar automaticamente ao iniciar o sistema:",
        sshHelpStep2LocalCode: "# No seu PC Local (Agente SSH para autenticação por chave):\nSet-Service -Name ssh-agent -StartupType Automatic\nStart-Service ssh-agent",
        sshHelpStep2RemoteCode: "# No Host Remoto (Servidor sshd):\nSet-Service -Name sshd -StartupType Automatic\nStart-Service sshd",
        sshHelpStep3Title: "3. Abrir a Porta 22 no Firewall (Host Remoto)",
        sshHelpStep3Body: "Garanta que a porta 22 está aberta para conexões de entrada no firewall do Windows Server remoto executando:",
        sshHelpStep3Code: "New-NetFirewallRule -Name \"OpenSSH-In\" -DisplayName \"OpenSSH Server (sshd)\" -Enabled True -Direction Inbound -Protocol TCP -Action Allow -LocalPort 22",
        sshHelpStep4Title: "4. Gerar e Configurar Chaves SSH (Recomendado)",
        sshHelpStep4Body: "No seu PC local, abra o PowerShell e gere seu par de chaves:",
        sshHelpStep4GenCode: "ssh-keygen -t ed25519 -f \"$HOME\\.ssh\\id_ed25519\"",
        sshHelpStep4SetupBody: "Depois, adicione o conteúdo da sua chave pública local ($HOME\\.ssh\\id_ed25519.pub) ao arquivo de chaves autorizadas no servidor remoto:",
        sshHelpStep4SetupCode: "# Na VM Remota (conta Administrator):\nC:\\Users\\Administrator\\.ssh\\authorized_keys",
